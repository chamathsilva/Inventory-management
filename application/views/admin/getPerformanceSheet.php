...
<div class="row"> <!--do not remove this -->
    ...
    <div class="col-lg-12">
        <h1 class="page-header" style="margin:50px 0px 20px">
            Performance <small>Reports</small>
        </h1>
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-dashboard"></i> Performance Reports
            </li>
        </ol>
...
<script type="text/javascript">
    ...
    function beforeSubmit(){
        ...
        window.open('../../controllers/calculateSalary/performancesheet.php?refname='+ namee +'&CurrentDatestart='+datee,'_blank');
