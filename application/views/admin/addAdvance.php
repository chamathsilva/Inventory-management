...
<div class="row"> <!--do not remove this -->
    ...
    <div class="col-lg-12">
        <h1 class="page-header" style="margin:50px 0px 20px">
            Add <small>advance</small>
        </h1>
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-dashboard"></i> Add advance
            </li>
        </ol>
        ...
        <div class="container" >
            ...
            <div class="col-sm-8 col-sm-offset-1">
                ...
                <form class="form-horizontal" id="userUploadForm" method = "POST" action="../../controllers/Advance/Advance.php" enctype="multipart/form-data">
